...
class QLearnBot(ValueBot):
    ...
    def __init__(self,world, load_file="save_bots/qbot.json", seenCoef, deathDealtCoef, foodEatenCoef, wasKilledCoef, doNothingPunishment, alpha, discount):
        ValueBot.__init__(self,world, load_file)
        self.nturns = 0
        self.percentSeen = 0
        self.lastPercentSeen = 0
        #Parameters from the qlearner_trainer
        self.seenCoef = seenCoef
        self.deathDealtCoef = deathDealtCoef
        self.foodEatenCoef = foodEatenCoef
        self.wasKilledCoef = wasKilledCoef
        self.doNothingPunishment = doNothingPunishment
        self.alpha = alpha
